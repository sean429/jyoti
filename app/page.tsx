    ...
    <div style={{ position: 'relative', minHeight: '100vh' }}>
      ...
      <div style={{ position: 'relative', zIndex: 1 }} className="flex flex-col items-center justify-center min-h-screen px-6">
        <div className="text-center mb-12">
          <p className="text-5xl mb-3 pulse-gold">✦</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-xl">
          <Link href="/ko" className="block">
            <div className="card glow-gold p-8 text-center hover:scale-105 transition-all cursor-pointer">
          ...
          <Link href="/en" className="block">
            <div className="card p-8 text-center hover:scale-105 transition-all cursor-pointer" style={{ border: '1px solid rgba(201,168,76,0.2)' }}>
              <p className="text-4xl mb-3">🌍</p>
        ...
        <p className="mt-10 text-xs" style={{ color: 'rgba(156,163,175,0.3)' }}>✦ 빛이 당신의 길을 밝혀드립니다 ✦</p>
      </div>
    </div>
  );
}

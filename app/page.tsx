        ...
        <div className="grid grid-cols-2 gap-3 w-full max-w-lg">
          <Link href="/ko" className="block">
            <div className="card glow-gold p-5 md:p-8 text-center hover:scale-105 transition-all cursor-pointer">
              ...
              <h2 className="font-cinzel font-bold text-base mb-1" style={{ color: 'var(--gold-light)' }}>한국어</h2>
              <p className="text-xs mb-3" style={{ color: 'var(--text-muted)' }}>인도 베딕 점성술<br />AI 한국어 운세 해석</p>
          ...
          <Link href="/en" className="block">
            <div className="card p-5 md:p-8 text-center hover:scale-105 transition-all cursor-pointer" style={{ border: '1px solid rgba(201,168,76,0.2)' }}>
              <p className="text-3xl md:text-4xl mb-2">🌍</p>
              <h2 className="font-cinzel font-bold text-base mb-1" style={{ color: 'var(--gold-light)' }}>English</h2>
              <p className="text-xs mb-3" style={{ color: 'var(--text-muted)' }}>Vedic Astrology<br />AI-powered Kundali readings</p>
